...
public class UbicacionDetalleDAOPostgres implements UbicacionDetalleDAO {
    ...
    public List<com.vendex.model.Inventario> listarProductosDisponibles() {
        List<com.vendex.model.Inventario> lista = new ArrayList<>();
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    com.vendex.model.Inventario inv = new com.vendex.model.Inventario();
