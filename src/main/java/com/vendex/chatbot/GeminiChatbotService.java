 ...
 * - Si hay GEMINI_API_KEY (env var o ~/.vendex/gemini.properties), usa Gemini para:
    ...
    private String preguntarConGemini(String texto, String apiKey) throws Exception {
        ...
        try {
            String promptRespuesta = """
                    Eres asistente Vendex. Responde breve en español (máx 3 líneas).
                    Consulta: "%s"
                    Sugerencia IA: %s
