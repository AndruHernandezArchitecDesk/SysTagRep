...
public class EtiquetaUtil {
    ...
    private static Path getEtiquetasDir() {
        ...
        Path dir = docs.resolve("etiquetas VENDEX");
        return dir;
    }
     ...
     */
    public static File generarEtiquetaUbicacion(Inventario item, com.vendex.model.UbicacionDetalle ubicacion, String rutaLogo, String razonSocial) {
    ...
    public static BufferedImage renderImagenEtiquetaConIndice(Inventario item, com.vendex.model.UbicacionDetalle ubicacion, int indice, int total, String rutaLogo) {
    ...
    private static File generarEtiquetaConIndice(Inventario item, com.vendex.model.UbicacionDetalle ubicacion, int indice, int total, String rutaLogo, String razonSocial) {
    ...
    public static List<File> generarEtiquetasPorUbicacion(Inventario item, com.vendex.model.UbicacionDetalle ubicacion, String rutaLogo, String razonSocial) {
